        ...
        <div class="row tm-register-row tm-mb-35">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-l">
                <form action="" method="post" class="tm-bg-black p-5 h-100">
                    ...
                    <div class="tm-flex-lr">
                        ...
                        <form method="POST" action="login_student.php"><input type="submit" name="Login" value="LOGIN" style="color:solid black">
                        </form>
                    </div>
                </form>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 tm-login-r">
                <header class="font-weight-light tm-bg-black p-5 h-100">
                    <h3 class="mt-0 text-white font-weight-light">Student Login</h3>
                    <p>Welcome UCoE's student here is your log in page</p>
